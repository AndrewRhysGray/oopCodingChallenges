...
// const helloSayer = admin.sayHello();
...
// On the basis of the User class, we are going to c
//reate the Author and Editor classes, and both will
// calculate the number of scores with the method 
//calcScores(), although the calculated value wi
//ll differ between the two classes.
